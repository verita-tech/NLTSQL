...
/// <remarks>
/// Deliberately forgiving: anything the model gets wrong that can be
/// dropped or defaulted is handled here, so that the validator downstream
/// reports the errors that actually matter — unknown members — rather than
/// a blank filter member the model emitted by accident.
/// </remarks>
